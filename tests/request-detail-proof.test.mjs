...
async function fixture(options = {}) {
  ...
  Object.assign(rawMaster, { unique_id: 'MASTER-SYNTHETIC-1', itemcode: 'ITEM-SYNTHETIC-1',
    ...
    contsize: options.contsize || null, spec: 'SERVER SPEC' });
  ...
  const names = ['firstNonEmptyValue', 'usesProductionMasterListProjection', 'getProductionMasterDetailContext',
...
async function requestCameraFixture() {
  const h = await fixture();
