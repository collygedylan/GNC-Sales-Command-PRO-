...
function harness(existingSession = storage()) {
  ...
  for (const name of ['rememberDeferredShellReload', 'hasPendingRequestCameraPhoto', 'isShellReloadHardBlocked', 'isShellReloadBlocked', 'shouldDeferVisibleShellReload', 'navigateToRecoveredShellBuild', 'applyDeferredShellReloadIfHidden', 'forceShellBuildReload', 'recoverStandaloneShellController']) {
