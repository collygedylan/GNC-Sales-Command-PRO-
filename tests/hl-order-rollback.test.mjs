...
test('Home and session fixtures recognize revision reads while blocking every network mutation', async () => {
  for (const file of ['home-role-visibility', 'session-recovery']) {
