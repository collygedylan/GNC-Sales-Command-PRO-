...
('ph_shear_list','{shear-list,tasks,request}',false),
...
('ph_eval_work','{tasks,request,managers}',false),
('ph_eval_work_origin_rows','{tasks,request,managers}',false),
('ph_eval_work_events','{tasks,request,managers}',false),
('ph_eval_report_settings','{tasks,managers}',false),
('ph_shear_location_inquiries','{shear-list,tasks,drive,request}',false),
('ph_shear_location_items','{shear-list,tasks,drive,request}',false),
('ph_shear_location_rows','{shear-list,tasks,drive,request}',false),
